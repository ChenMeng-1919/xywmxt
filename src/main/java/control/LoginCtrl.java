    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
            ...
            if (!pagerandom.equals(random) && request.getParameter("a") != null) {
                ...
                String sql1 = "";
                                        ...
                                        sql1 = "select * from yonghu where yonghuming='" + username + "' and mima='" + password + "' ";
                                                                                                                                                                                                ...
                                                                                                                                                                                                if (utype.equals("骑士")) {
                                        sql1 = "select * from qishi where yonghuming='" + username + "' and mima='" + password + "' ";
                }
        ...
        if (ac.equals("adminuppass")) {
            ...
            String biao = "";
                ...
                biao = "qishi";
                                m = Query.make(biao).where("yonghuming",username).where("mima",olduserpass).find();
                // dao.getmaps("yonghuming", (String) request.getSession().getAttribute("username"), "qishi");
                            }
            ...
            if (m == null || m.isEmpty()) {
                ...
                String sql = "";
                    ...
                    sql = "UPDATE yonghu SET mima='"+userpass+"' WHERE yonghuming='"+username+"'";
                                ...
                                if(cx.equals("骑士")){
                    sql = "UPDATE qishi SET mima='"+userpass+"' WHERE yonghuming='"+username+"'";
                }

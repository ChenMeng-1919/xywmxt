...
<div class="container"><!-- 使用bootstrap css框架，container定宽，并剧中 https://v3.bootcss.com/css/#overview-container -->
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <form action="paisong.jsp?a=insert" method="post" name="form1" id="form1"><!-- form 标签开始 -->
...
<%= readMap.get("dizhi") %><input type="hidden" id="dizhi" name="dizhi" value="<%= Info.html(readMap.get("dizhi")) %>"/>
    ...
    <div class="row">
        ...
        <div class="col-sm-10">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="输入派送姓名" style="width:150px;" id="paisongxingming" name="paisongxingming" value="<%= request.getSession().getAttribute("xingming") !=null ? request.getSession().getAttribute("xingming") : "" %>"/>                                            
        </div>
    ...
    <div class="row">
        ...
        <div class="col-sm-10">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="输入派送电话" style="width:150px;" phone="true" data-msg-phone="请输入正确手机号码" id="paisongdianhua" name="paisongdianhua" value="<%= request.getSession().getAttribute("shouji") !=null ? request.getSession().getAttribute("shouji") : "" %>"/>                                            
        </div>
    ...
    <div class="row">
        ...
        <div class="col-sm-10">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="输入派送人" style="width:150px;" readonly="readonly" id="paisongren" name="paisongren" value="<%= request.getSession().getAttribute("username") !=null ? request.getSession().getAttribute("username") : "" %>"/>                                            
        </div>

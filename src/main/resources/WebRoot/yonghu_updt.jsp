...
$(".class_xingbie4").val($(".class_xingbie4").attr("data-value"))</script>
    ...
    <div class="row">
        ...
        <div class="col-sm-10">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="输入手机" style="width:150px;" tel="true" data-msg-phone="请输入正确固定号码" id="shouji" name="shouji" value="<%= Info.html(mmm.get("shouji")) %>"/>                                            
        </div>

...
<div class="container"><!-- 使用bootstrap css框架，container定宽，并剧中 https://v3.bootcss.com/css/#overview-container -->
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <form action="shangpin.jsp?a=update" method="post" name="form1" id="form1"><!-- form 标签开始 -->
    ...
    <div class="row">
        ...
        <div class="col-sm-10">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="输入商品编号" style="width:150px;" readonly="readonly" id="shangpinbianhao" name="shangpinbianhao" value="<%= Info.html(mmm.get("shangpinbianhao")) %>"/>                                            
        </div>
    ...
    <div class="row">
        ...
        <div class="col-sm-10">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="输入商品名称" style="width:250px;" id="shangpinmingcheng" name="shangpinmingcheng" value="<%= Info.html(mmm.get("shangpinmingcheng")) %>"/>                                            
        </div>
    ...
    <input type="text" class="form-control" id="shangpintupian" name="shangpintupian" value="<%= Info.html(mmm.get("shangpintupian")) %>"/>
...
$(".class_fenlei8").val($(".class_fenlei8").attr("data-value"))</script>
    ...
    <div class="row">
        ...
        <div class="col-sm-10">
                                                    ...
                                                    <input type="number" class="form-control" placeholder="输入库存" style="width:150px;" data-rule-required="true" data-msg-required="请填写库存" number="true" data-msg-number="输入一个有效数字" id="kucun" name="kucun" value="<%= Info.html(mmm.get("kucun")) %>"/>                                            
        </div>
    ...
    <div class="row">
        ...
        <div class="col-sm-10">
                                                    ...
                                                    <input type="number" class="form-control" placeholder="输入送餐费" style="width:150px;" step="0.01" number="true" data-msg-number="输入一个有效数字" id="songcanfei" name="songcanfei" value="<%= Info.html(mmm.get("songcanfei")) %>"/>                                            
        </div>
    ...
    <div class="row">
        ...
        <div class="col-sm-10">
                                                    ...
                                                    <input type="number" class="form-control" placeholder="输入价格" style="width:150px;" step="0.01" data-rule-required="true" data-msg-required="请填写价格" number="true" data-msg-number="输入一个有效数字" id="jiage" name="jiage" value="<%= Info.html(mmm.get("jiage")) %>"/>                                            
        </div>

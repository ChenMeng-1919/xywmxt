...
// 以下是检测搜索框中是否填写了或者选择了什么，则写入sql 语句中
             ...
             if(request.getParameter("xingming") != null && !"".equals( request.getParameter("xingming") )){ where+=" AND xingming LIKE '%"+request.getParameter("xingming")+"%'"; } 
                 if(request.getParameter("dianhua") != null && !"".equals( request.getParameter("dianhua") )){ where+=" AND dianhua LIKE '%"+request.getParameter("dianhua")+"%'"; } 
                
List<HashMap> list = Query.make("shouhuodizhi").where(where).order(orderby+" "+sort).page(15);
...
<div class="panel panel-default">
    ...
    电话
                            ...
                            <input type="text" class="form-control" style="" name="dianhua" value="<%= request.getParameter("dianhua") !=null ? request.getParameter("dianhua") : "" %>"/>                        
</div>
...
<td> <%= Info.subStr(map.get("addtime") , 19 , "") %> </td>
                                                                ...
                                                                <a href="shouhuodizhi_updt.jsp?id=<%= map.get("id") %>">编辑</a>
                                                                <a href="shouhuodizhi.jsp?a=delete&id=<%= map.get("id") %>" onclick="return confirm('确定要删除？')">删除</a>
                                                        <!--qiatnalijne-->
                        </td>
                    </tr>
                    <% } %>

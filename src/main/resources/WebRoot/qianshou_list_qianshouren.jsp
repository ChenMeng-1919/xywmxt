...
// 以下是检测搜索框中是否填写了或者选择了什么，则写入sql 语句中
    ...
    where += " AND dingdanid='"+request.getParameter("dingdanid")+"' ";
                 ...
                 if(request.getParameter("dingdanbianhao") != null && !"".equals( request.getParameter("dingdanbianhao") )){ where+=" AND dingdanbianhao LIKE '%"+request.getParameter("dingdanbianhao")+"%'"; } 
...
<td> <%= Info.subStr(map.get("addtime") , 19 , "") %> </td>
                                                                ...
                                                                <a href="qianshou_detail.jsp?id=<%= map.get("id") %>">详情</a>
<%--                                                                <a href="qianshou_updt.jsp?id=<%= map.get("id") %>">编辑</a>--%>
<%--                                                                <a href="qianshou.jsp?a=delete&id=<%= map.get("id") %>" onclick="return confirm('确定要删除？')">删除</a>--%>
                                                        <!--qiatnalijne-->
                        </td>
                    </tr>
                    <% } %>

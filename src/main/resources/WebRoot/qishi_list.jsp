...
List<HashMap> list = Query.make("qishi").where(where).order(orderby+" "+sort).page(15);
...
<td> <%= Info.subStr(map.get("addtime") , 19 , "") %> </td>
                                                                ...
                                                                <a href="qishi_updt.jsp?id=<%= map.get("id") %>">编辑</a>
                                                                <a href="qishi.jsp?a=delete&id=<%= map.get("id") %>" onclick="return confirm('确定要删除？')">删除</a>
                                                        <!--qiatnalijne-->
                        </td>
                    </tr>
                    <% } %>

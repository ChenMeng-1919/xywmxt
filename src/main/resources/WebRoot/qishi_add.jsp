...
<div class="container"><!-- 使用bootstrap css框架，container定宽，并剧中 https://v3.bootcss.com/css/#overview-container -->
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <form action="qishi.jsp?a=insert" method="post" name="form1" id="form1"><!-- form 标签开始 -->
    ...
    <div class="row">
        ...
        <div class="col-sm-10">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="输入用户名" style="width:150px;" data-rule-required="true" data-msg-required="请填写用户名" remote="factory/checkno.jsp?checktype=insert&table=qishi&col=yonghuming" data-msg-remote="内容重复了" id="yonghuming" name="yonghuming" value=""/>                                            
        </div>
    ...
    <div class="row">
        ...
        <div class="col-sm-10">
                                                    ...
                                                    <select class="form-control class_xingbie9" data-value="" id="xingbie" name="xingbie" style="width:250px">

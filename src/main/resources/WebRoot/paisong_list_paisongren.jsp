...
String where = " 1=1 ";   // 防止sql 搜索条件为： where and a=b 这样的错误
    where += " AND paisongren='"+request.getSession().getAttribute("username")+"' "; //  设置paisongren为当前登录用户
...
<td> <%= Info.subStr(map.get("addtime") , 19 , "") %> </td>
                                                                ...
                                                                <a href="paisong.jsp?a=delete&id=<%= map.get("id") %>" onclick="return confirm('确定要删除？')">删除</a>
                                                        <!--qiatnalijne-->
                        </td>
                    </tr>
                    <% } %>
